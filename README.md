...
### 1. [OPERA: Over-Trust Penalty and Retrospection-Allocation](https://hf.co/papers/2311.17911)
...
### 2. [Data-augmented Phrase-level Alignment (DPA)](https://hf.co/papers/2405.18654)
...
### 3. [ConVis: Contrastive Decoding with Hallucination Visualization](https://hf.co/papers/2408.13906)
...
### 4. [Woodpecker: Hallucination Correction for Multimodal Large Language Models](https://hf.co/papers/2310.16045)
...
### 5. [Thinking Before Looking: Improving Multimodal LLM Reasoning via Mitigating Visual Hallucination (VIC)](https://hf.co/papers/2411.12591)
...
### 6. [Look Twice Before You Answer: Memory-Space Visual Retracing for Hallucination Mitigation (MemVR)](https://hf.co/papers/2410.03577)
...
### 7. [VCD: A General Decoding Strategy for Mitigating Hallucination in MLLMs](https://hf.co/papers/2408.13906)
...
### 8. [Mitigating Object-Related Hallucination in Large Vision-Language Models (LURE-Correct)](https://hf.co/papers/2410.11779)
...
### 9. [Object-level Hallucination in Vision-Language Models (POPE)](https://hf.co/papers/2410.23114)
...
### 10. [LURE: A Benchmark for Hallucination Evaluation and Reasoning in Large Vision-Language Models](https://hf.co/papers/2310.00754)
...
### 11. [HaELM: Hallucination-aware Ensemble of Experts for Mitigating Hallucinations in MLLMs](https://hf.co/papers/2308.15126)
...
### 12. [Hallucination-in-Context: A New Benchmark and A Simple Method (HIC)](https://hf.co/papers/2504.17550)
...
### 13. [GAVIE: A General and Efficient Tuning-Free Approach for Vision-Language Instruction Following](https://hf.co/papers/2306.14565)
